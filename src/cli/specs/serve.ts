...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'orca serve [--port <port>] [--bind-host 127.0.0.1] [--pairing-address <host>] [--mobile-pairing] [--no-pairing] [--project-root <path>] [--recipe-json] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'port',
      'bind-host',
    ...
    notes: [
      ...
      '--bind-host 127.0.0.1 pins the listener to loopback for its entire lifetime; without it, serve binds all interfaces.',
    ...
    examples: [
      ...
      'orca serve --bind-host 127.0.0.1 --pairing-address 127.0.0.1',
